    ...
    <>
      ...
      <section id="about" className="relative w-full min-h-screen flex flex-col bg-[var(--background)] text-[var(--dark-green)] overflow-hidden font-sans">
        ...
        <div className="w-full bg-[var(--dark-green)] text-[var(--background)] py-3 overflow-hidden flex whitespace-nowrap z-30 shrink-0 select-none">
          <div className="font-[family-name:var(--font-body)] animate-marquee shrink-0 flex items-center text-xs font-medium uppercase tracking-[0.3em]">
          ...
          <div className="animate-marquee shrink-0 flex items-center text-xs font-mono font-medium uppercase tracking-[0.3em]" aria-hidden="true">
            {Array.from({ length: 12 }).map((_, i) => (
              <React.Fragment key={i}>
                <span className="px-8">Creative Developer</span>
                <span className="w-1.5 h-1.5 rounded-full bg-[var(--background)] inline-block opacity-40" />
        ...
        <div className="w-full max-w-5xl mx-auto px-6 md:px-12 lg:px-16 flex flex-col justify-start pt-4 md:pt-7 lg:pt-10 selection:bg-[var(--dark-green)] selection:text-[var(--background)]">
          <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 lg:gap-20 items-center">
            ...
            <div className="col-span-1 md:col-span-7 flex flex-col justify-center">
              ...
              <p className="text-xs font-[family-name:var(--font-body)] uppercase tracking-[0.3em] text-[var(--dark-green)] font-bold mb-8 opacity-80">
